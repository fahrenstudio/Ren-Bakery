...
if (insert_produk($_POST, $_FILES) > 1){
    $error = true;
} else {
    $error = false;
}
    ...
    <?php if (isset($_POST["insert"]) ) : ?>    
        ...
        <div class="container mt-5">
            <form action="" method="post" enctype="multipart/form-data" class="border border-dark container">
                ...
                <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Judul Roti</label>
                <input name="judul" type="text" class="form-control" id="formGroupExampleInput" placeholder="Nama Roti" autocomplete="off" autofocus="on" required>
                </div>
                <div class="mb-3">
